  ...
  return (
    <Container className="grid grid-cols-1 lg:grid-cols-2 gap-4 py-4">
      <div
        className={`${
          reverse ? "lg:order-2" : ""
        } relative flex items-center justify-center w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[500px] lg:h-[500px] xl:w-[600px] xl:h-[600px] bg-primary rounded-full m-auto overflow-hidden`}
      >
        ...
        {/* <div className="absolute -left-0 top w-[20%] h-[20%] flex justify-center items-center overflow-hidden rounded-full border-2 -rotate-45 border-backround">
          <img
            className="min-w-full w-auto"
            src={"images/security/" + imageUrl}
            alt="security photo"
